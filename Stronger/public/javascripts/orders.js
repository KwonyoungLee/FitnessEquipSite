$(document).ready(function () {
    ...
    $("#dob").append("Date of Birth: " + dob_string)
    $.ajax({
        method: 'GET',
    ...
    $.ajax({
        ...
        success: function (user) {
            if (user.billing_address != "" && user.billing_address.bill_apt != "") {
                $("#address").append(`<b>Billing Address</b> <br>` + user.billing_address.bill_address + `<br>` +
                ...
                $("#address").append(`<b>Billing Address</b> <br>` + user.billing_address.bill_address + `<br>` + user.billing_address.bill_city + `, `
                + user.billing_address.bill_state + ` ` + user.billing_address.bill_zip +
                `<br>` + user.billing_address.bill_country);
            }
        },
